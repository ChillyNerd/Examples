...
def get_project_endpoints(project_path: str):
    ...
    for file in file_list:
        ...
        if java_class:
            ...
            if "@RestController" in file_content:
                ...
                logger.info(f"RestController {groups['class_name']}")
                ...
                rest_controllers.extend(controller_endpoints)
            if "@FeignClient" in file_content:
                ...
                if feign_client:
                    ...
                    feign_clients[client_name] = client_endpoints
    return classes, rest_controllers, feign_clients
